...
<p align="center">
  <img src="https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/assets/hbnb_stack.png"
	    alt="HBnB stack">
</p>
...
| ----- | ----- | ------ |
| 0: Authors/README File | [AUTHORS](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/AUTHORS) | Project authors |
| 1: Pep8 | N/A | All code is pep8 compliant|
| 2: Unit Testing | [/tests](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/tree/master/tests) | All class-defining modules are unittested |
| 3. Make BaseModel | [/models/base_model.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/master/models/base_model.py) | Defines a parent class to be inherited by all model classes|
| 4. Update BaseModel w/ kwargs | [/models/base_model.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/base_model.py) | Add functionality to recreate an instance of a class from a dictionary representation|
| 5. Create FileStorage class | [/models/engine/file_storage.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/engine/file_storage.py) [/models/_ _init_ _.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/__init__.py) [/models/base_model.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/base_model.py) | Defines a class to manage persistent file storage system|
| 6. Console 0.0.1 | [console.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/console.py) | Add basic functionality to console program, allowing it to quit, handle empty lines and ^D |
| 7. Console 0.1 | [console.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/console.py) | Update the console with methods allowing the user to create, destroy, show, and update stored data |
| 8. Create User class | [console.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/console.py) [/models/engine/file_storage.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/engine/file_storage.py) [/models/user.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/user.py) | Dynamically implements a user class |
| 9. More Classes | [/models/user.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/user.py) [/models/place.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/place.py) [/models/city.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/city.py) [/models/amenity.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/amenity.py) [/models/state.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/state.py) [/models/review.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/review.py) | Dynamically implements more classes |
| 10. Console 1.0 | [console.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/console.py) [/models/engine/file_storage.py](https://github.com/Abeer-M-Ali/AirBnB_clone_v2/blob/master/models/engine/file_storage.py) | Update the console and file storage system to work dynamically with all  classes update file storage |
<br>
<br>
...
Alx School School and I want to show it off as a demonstration of all the
...
(viewable [here](https://github.com/Abeer-M-Ali/AirBnB_clone)), I, together
...
Alx School students from an older cohort. We then pair programmed
...
[version one](https://github.com/Abeer-M-Ali/AirBnB_clone) (the
...
(hbnb)
(hbnb) all BaseModel
["[BaseModel] (450490fd-344e-47cf-8342-126244c2ba99) {'updated_at': datetime.datetime(2019, 2, 17, 21, 45, 5, 963516), 'created_at': datetime.datetime(2019, 2
...
(hbnb)
(hbnb) User.all()
["[User] (8f2d75c8-fb82-48e1-8ae5-2544c909a9fe) {'updated_at': datetime.datetime
...
(hbnb)
(hbnb) update User 6f348019-0499-420f-8eec-ef0fdc863c02 first_name "Alx School" 
(hbnb) show User 6f348019-0499-420f-8eec-ef0fdc863c02
[User] (6f348019-0499-420f-8eec-ef0fdc863c02) {'created_at': datetime.datetime(
2019, 2, 17, 21, 54, 39, 234382), 'first_name': 'Alx School', 'updated_at': date
...
Unittest for the HBnB project are defined in the [tests](./tests)
